...
def traitement(zi) : #This function supposes that empty lists called  GP2_min, DP2_min, GP_min, DP_min, GP2_max, DP2_max, GP_max and DP_max were created. It allows to fulfill these lists using the zi variable which was created by hand labelling
