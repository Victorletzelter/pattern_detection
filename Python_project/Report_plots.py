###This script allows to reproduce the plots given in the report.

#The execution of this lines between the #### is required for running the code

####
import os #Execution for the python scripts related to the algorithm.
os.chdir("/Users/victorletzelter/Documents/GitHub/pattern_detection/Python project") #This line may have to be adapted
